...
import 'package:flutter_auth/Screens/B_08%20Teachers_Lists/teacher_list_screen.dart';
...
class StudentEduBody extends StatefulWidget {
  @override
  State<StudentEduBody> createState() => _StudentEduBodyState();
}

@override
void initState() {}

class _StudentEduBodyState extends State<StudentEduBody> {
  @override
            ...
            Container(
              ...
              child: Column(children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  RoundedButton2(
                      text: "الصف الثالث   ", x: 45, y: 90, press: () {}),
                  Padding(padding: EdgeInsets.all(4)),
                  RoundedButton2(
                      text: "الصف الثاني  ", x: 45, y: 90, press: () {}),
                  Padding(padding: EdgeInsets.all(4)),
                  RoundedButton2(
                      text: "الصف الأول   ",
                      x: 45,
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  RoundedButton2(
                      text: "الصف السادس    ", x: 45, y: 100, press: () {}),
                  Padding(padding: EdgeInsets.all(4)),
                  RoundedButton2(
                      text: "الصف الخامس  ", x: 45, y: 100, press: () {}),
                  Padding(padding: EdgeInsets.all(4)),
                  RoundedButton2(
                      text: "الصف الرابع  ", x: 45, y: 90, press: () {}),
                ]),
                SizedBox(height: size.height * 0.01),

                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  RoundedButton2(
                      text: "الصف التاسع  ", x: 45, y: 90, press: () {}),
                  Padding(padding: EdgeInsets.all(4)),
                  RoundedButton2(
                      text: "الصف الثامن  ", x: 45, y: 100, press: () {}),
                  Padding(padding: EdgeInsets.all(4)),
                  RoundedButton2(
                      text: "الصف السابع  ", x: 45, y: 100, press: () {}),
                ]),
                SizedBox(height: size.height * 0.01),

                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  RoundedButton2(
                      text: "الباكالوريا ", x: 45, y: 70, press: () {}),
                  Padding(padding: EdgeInsets.all(4)),
                  RoundedButton2(
                      text: "الصف الحادي عشر  ", x: 45, y: 120, press: () {}),
                  Padding(padding: EdgeInsets.all(4)),
                  RoundedButton2(
                      text: "الصف العاشر  ", x: 45, y: 100, press: () {}),
                ]),
              ]),
            ),
          ]),
